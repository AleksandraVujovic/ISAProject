...
const routes: Routes = [
  ...
  { path: 'register-admin', component: RegisterAdminComponent, canActivate:[Guard], data:{permittedRoles:["ROLE_HEADADMIN"]} },
  ...
  { path: 'view-users', component: ViewUsersComponent, canActivate:[Guard], data:{permittedRoles:["ROLE_HEADADMIN", "ROLE_ADMIN"]} },
  ...
  { path: 'register-head-admin', component: RegisterHeadAdminComponent, canActivate:[Guard], data:{permittedRoles:["ROLE_HEADADMIN"]} },
